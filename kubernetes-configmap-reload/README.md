...
-------
    git clone https://github.com/deepak-putta/spring-cloud-kubernetes.git
...
--------------
    docker build -t deepakputta/kubernetes-configmap-reload .
...
-----------
    docker push deepakputta/kubernetes-configmap-reload
